...
if __name__ == "__main__":
    old_file = followers_dir + "/" + "followers2026-05-07.json"  # Change this to the previous followers or following file
    new_file = followers_dir + "/" + "followers2026-05-11.json"  # Change this to the new followers or following file
